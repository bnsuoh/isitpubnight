...
var pubdays =
	[
		...
		[new Date("1/9/20"), pubType.REGULAR],
		[new Date("1/14/20"), pubType.REGULAR],
		...
		[new Date("2/27/20"), pubType.CLASSY],
		[new Date("3/5/20"), pubType.REGULAR],
		[new Date("3/12/20"), pubType.REGULAR],
		[new Date("3/26/20"), pubType.CLASSY],
		[new Date("4/2/20"), pubType.REGULAR],
		[new Date("4/9/20"), pubType.REGULAR],
		[new Date("4/16/20"), pubType.REGULAR],
		[new Date("4/23/20"), pubType.REGULAR],
		[new Date("4/30/20"), pubType.CLASSY],
		[new Date("5/7/20"), pubType.REGULAR],
		[new Date("5/12/20"), pubType.REGULAR],
		[new Date("5/21/20"), pubType.CLASSY],
